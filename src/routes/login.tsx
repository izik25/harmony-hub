...
import { getAuthProviders, login, type SessionUser } from "@/functions/auth";
...
function LoginPage() {
  ...
  useEffect(() => {
    ...
    toast.error(translateServerError(search.authError));
            ...
            {method === "phone" && providers?.phone ? (
              ...
              >
                ...
                <motion.button
                  ...
                  className="animate-fade-up stagger-4 w-full rounded-full bg-brand-coral py-3 text-sm font-bold text-white shadow-pop-coral disabled:opacity-60"
                >
